...
**Layer 4 — Atomic Components:** Reusable UI building blocks from shadcn/ui (49 components: Button, Card, Dialog, DropdownMenu, Tabs, etc.), board-specific components (11 cell types, view components, filter/sort panels), and feature components (modals, sidebars, widgets).
