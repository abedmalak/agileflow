...
- **AIProvider** (`src/components/ai/AIProvider.jsx`) — Manages AI state: active session, message history, streaming state, model selection, tool execution loop.
